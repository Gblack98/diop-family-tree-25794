-- ============================================================================
-- RÉINITIALISATION ET MIGRATION DES ARCHIVES
-- À exécuter dans le SQL Editor de Supabase (admin)
-- Supprime toutes les archives existantes et réimporte les 18 officielles
-- ============================================================================

DO $reset$
BEGIN
  -- Étape 1 : Supprimer toutes les archives existantes
  DELETE FROM archives;
  RAISE NOTICE '✅ Toutes les archives existantes ont été supprimées';
END $reset$;

-- ============================================================================
-- RÉIMPORTATION DES 18 ARCHIVES OFFICIELLES
-- ============================================================================
...
Au fil des années, il forme plus de 34 promotions d'ingénieurs. Des générations d'étudiants passent par ses amphithéâtres et ses travaux dirigés. Beaucoup d'entre eux occupent aujourd'hui des postes importants dans l'administration, les entreprises et les bureaux d'études du Sénégal et d'ailleurs.$t$,
  ...
  RAISE NOTICE 'Toutes les images et données sont incluses.';
